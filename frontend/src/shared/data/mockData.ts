...
export const mockRestaurants: Restaurant[] = [
  {
    ...
    address: 'Rua Vergueiro, 2000 - Vila Mariana, Fortaleza - CE',
    phone: '(85) 3456-7890',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1613274554329-70f997f5789f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50JTIwaW50ZXJpb3IlMjBtb2Rlcm58ZW58MXx8fHwxNzYzMDI3NjM1fDA&ixlib=rb-4.1.0&q=80&w=1080',
    address: 'Av. Faria Lima, 3000 - Itaim Bibi, Fortaleza - CE',
    phone: '(85) 2345-6789',
...
export const mockProducts: Product[] = [
  {
    ...
    restaurantId: '1',
    variations: [
      { id: '1-1', name: 'Pequena', price: 29.9 },
      { id: '1-2', name: 'Média', price: 39.9 },
      { id: '1-3', name: 'Grande', price: 49.9 },
    ],
    addons: [
      { id: '1', name: 'Borda recheada', price: 8.0 },
      { id: '2', name: 'Bacon extra', price: 5.0 },
      { id: '3', name: 'Azeitonas', price: 3.0 },
    ],
    stockQuantity: 50,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    restaurantId: '1',
    variations: [
      { id: '2-1', name: 'Pequena', price: 32.9 },
      { id: '2-2', name: 'Média', price: 42.9 },
      { id: '2-3', name: 'Grande', price: 52.9 },
    ],
    addons: [
      { id: '1', name: 'Borda recheada', price: 8.0 },
      { id: '2', name: 'Bacon extra', price: 5.0 },
  ...
  },
  {
    ...
    restaurantId: '1',
    variations: [
      { id: '3-1', name: 'Pequena', price: 35.9 },
      { id: '3-2', name: 'Média', price: 45.9 },
      { id: '3-3', name: 'Grande', price: 55.9 },
    ],
    addons: [
      { id: '1', name: 'Borda recheada', price: 8.0 },
    ],
  ...
  },
  {
    ...
    restaurantId: '1',
    variations: [
      { id: '4-1', name: 'Unidade', price: 12.9 },
    ],
    stockQuantity: 100,
    isActive: true,
    isFeatured: false,
  ...
  },
  {
    ...
    restaurantId: '1',
    variations: [
      { id: '5-1', name: 'Unidade', price: 11.9 },
    ],
    stockQuantity: 80,
    isActive: true,
    isFeatured: false,
  ...
  },
  {
    ...
    restaurantId: '1',
    variations: [
      { id: '6-1', name: 'Unidade', price: 18.9 },
    ],
    stockQuantity: 30,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    restaurantId: '1',
    variations: [
      { id: '71', name: 'Porção Individual', price: 32.9 },
      { id: '72', name: 'Porção para 2', price: 54.9 },
    ],
    stockQuantity: 35,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    restaurantId: '1',
    variations: [
      { id: '81', name: 'Individual', price: 24.9 },
    ],
    stockQuantity: 25,
    isActive: true,
    isFeatured: false,
  ...
  },
  {
    ...
    restaurantId: '2',
    variations: [
      { id: '91', name: 'Individual', price: 34.9 },
      { id: '92', name: 'Com Fritas', price: 42.9 },
    ],
    addons: [
      { id: '4', name: 'Bacon extra', price: 6.0 },
      { id: '5', name: 'Queijo extra', price: 5.0 },
      { id: '6', name: 'Ovo', price: 3.0 },
    ],
    stockQuantity: 40,
    isActive: true,
    isFeatured: true,
...
export const mockOrders: Order[] = [
  {
    ...
    items: [
      {
        ...
        variationId: '1-3',
        variation: { id: '1-3', name: 'Grande', price: 49.9 },
        addons: [],
        quantity: 1,
        subtotal: 49.9,
      },
    ...
    total: 57.61,
    status: 'delivered',
    createdAt: '2025-11-23T15:50:09Z',
    updatedAt: '2025-11-23T15:50:33Z',
    estimatedDeliveryTime: '16:20',
  },
  {
    id: '5',
    customerId: '3',
    customerName: 'Clara Andrade',
    customerPhone: '8596684564',
    restaurantId: '1',
    restaurantName: 'Pizzaria Bella Napoli',
    items: [
      {
        ...
        variationId: '2-2',
        variation: { id: '2-2', name: 'Média', price: 42.9 },
        addons: [],
        quantity: 1,
        subtotal: 42.9,
      },
    ...
    total: 51.8,
    status: 'preparing',
    createdAt: '2025-11-23T02:30:50Z',
    updatedAt: '2025-11-23T15:45:12Z',
    estimatedDeliveryTime: '03:00',
  },
  {
    id: '4',
    customerId: '3',
    ...
    items: [
      {
        ...
        product: mockProducts[1],
        variationId: '2-1',
        variation: { id: '2-1', name: 'Pequena', price: 32.9 },
        addons: [],
        quantity: 1,
        subtotal: 32.9,
      },
    ...
    total: 41.8,
    status: 'pending',
    createdAt: '2025-11-23T02:25:49Z',
    updatedAt: '2025-11-23T02:25:49Z',
    estimatedDeliveryTime: '02:55',
  },
  {
    id: '1',
    customerId: '1',
    ...
    items: [
      {
        ...
        variationId: '1-3',
        variation: { id: '1-3', name: 'Grande', price: 49.9 },
        addons: [{ id: '1', name: 'Borda recheada', price: 8.0 }],
        quantity: 1,
        subtotal: 57.9,
      },
    ],
